...
/**
 * The DayMapper class provides methods to map between day abbreviations and DayOfWeek values.
 * <p>
 * The class uses two static maps, ABBREVIATION_TO_DAY_MAP and DAY_TO_ABBREVIATION_MAP, to store the mappings.
 */
